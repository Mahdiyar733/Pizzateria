	...
	return (
		<>
			{!isMobile ? (
				...
				<div className="flex flex-col items-center justify-between border border-gray-300 border-solid rounded-box overflow-hidden bg-gradient-to-t from-white from-80% to-[#2B2B2B] shadow-shdw max-w-[300px]">
					<img
						src={src}
						alt={name}
						className="hidden"
