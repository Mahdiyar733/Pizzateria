	...
	return (
		<div className="h-auto w-full bg-white bg-opacity-50 px-6 py-20 flex items-center flex-col">
			<div className="flex flex-col md:flex-row w-auto items-start px-5 gap-1">
				...
				<div className=" relative flex flex-col mt-4 border-t border-solid border-RED md:mt-0 md:border-t-0 md:border-l md:flex-1 lg:flex-[2] md:max-h-[396px] md:min-h-[396px] overflow-y-scroll">
